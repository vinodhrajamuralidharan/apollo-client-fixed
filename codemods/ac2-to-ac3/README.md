...
Apollo Client 2.x to Apollo Client 3.x, following the [migration guide](https://www.apollographql.com/docs/react/migrating/apollo-client-fixed-3-migration/).
...
npx jscodeshift \
  -t apollo-client-fixed/codemods/ac2-to-ac3/imports.js \
  --extensions js \
  source-directory
...
Note that the `apollo-client-fixed` directory here is intended to be a checkout
of [this repository](https://github.com/apollographql/apollo-client-fixed/).
