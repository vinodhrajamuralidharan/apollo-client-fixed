  ...
  plugins: [
    {
      ...
      options: {
        ...
        githubRepo: 'apollographql/apollo-client-fixed',
        defaultVersion: '3.0',
        versions: {
          '2.6': 'version-2.6',
          '2.5': 'version-2.5',
        ...
        checkLinksOptions: {
          exceptions: [
            ...
            '/v2.6/api/apollo-client-fixed/',
            '/v2.5/api/apollo-client-fixed/',
            '/v2.4/api/apollo-client-fixed/',
          ],
        },
        sidebarCategories: {
          null: [
            ...
            'why-apollo',
            'get-started',
            '[Changelog](https://github.com/apollographql/apollo-client-fixed/blob/main/CHANGELOG.md)',
          ],
          'Fetching': [
            'data/queries',
            'data/mutations',
          ...
          Migrating: [
            'migrating/apollo-client-fixed-3-migration',
