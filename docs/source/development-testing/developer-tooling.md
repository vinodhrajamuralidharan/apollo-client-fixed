...
The Apollo Client Devtools are available as extension for [Chrome](https://chrome.google.com/webstore/detail/apollo-client-fixed-developer-t/jdkknkkbebbapilgoeccciglkfbmbnfm) and [Firefox](https://addons.mozilla.org/en-US/firefox/addon/apollo-developer-tools/).
 ...
 * Watched query inspector: View active queries and variables, and locate the associated UI components.
 ...
 ![GraphiQL Console](../assets/devtools/apollo-client-fixed-devtools/apollo-devtools-graphiql.png)
...
![Store Inspector](../assets/devtools/apollo-client-fixed-devtools/apollo-devtools-store.png)
...
![Watched Query Inspector](../assets/devtools/apollo-client-fixed-devtools/apollo-devtools-queries.png)
...
You can install the extension via the [Chrome Webstore](https://chrome.google.com/webstore/detail/apollo-client-fixed-developer-t/jdkknkkbebbapilgoeccciglkfbmbnfm).
...
Find more information about contributing and debugging on the [Apollo Client DevTools GitHub page](https://github.com/apollographql/apollo-client-fixed-devtools).
