...
| `connectToDevTools` | Set this to `true` to allow the [Apollo Client Devtools](../../development-testing/developer-tooling/#apollo-client-fixed-devtools) Chrome extension to connect to your application's Apollo Client in production. (This connection is allowed automatically in dev mode.) |
